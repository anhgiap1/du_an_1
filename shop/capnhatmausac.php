<?php
            ...
            if (isset($_POST['capnhat'])) {
                ...
                if(empty($error)){
                $update="update mau_sac set gia_tri='$gtri' where ma_ms='$id'";
                pdo_execute($update);
...
<div class="shop-page-content">
    ...
    <div class="themdm">
        <p class="tieude">Cập nhật màu sắc </p>
        <form action="" method="POST">
            <div class="add">
                <label for="" class="gia-tri" style="width:80px;font-size: 16px">Giá trị </label>
                <div>
                    <input type="text" name="giatri" class="tennganhhang" value="<?= $mausac['gia_tri'] ?>">
                </div>
            </div>
